...
let btnDesistirDesaparecer = document.getElementById("btn-desistir").style.display = "none";
let divAgregarPalabra = document.getElementById("ingresar-palabra").style.display = 'none';
...
function ensenarPantallaDeAgregarPalabra() {
  ...
  document.getElementById("ingresar-palabra").style.display = "block";
...
function guardarPalabra() {
  ...
  if(nuevaPalabra !== "") {
    ...
    alert("Ninguna palabra ha sido encontrada");
  }
